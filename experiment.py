...
from decision_transformer.training.s2vr_trainer import Trainer as Agent
...
def experiment(
    ...
    bcmodel = model = DecisionTransformer(
        state_dim=state_dim,
        act_dim=act_dim,
        max_length=K,
        max_ep_len=max_ep_len,
...
if __name__ == '__main__':
    ...
    parser.add_argument("--eta2", default=0.99, type=float)
    parser.add_argument("--lambda", default=1.0, type=float)
    # ---------------------------------------------------------------------- #
    parser.add_argument("--alpha", type=float, default=1.0)
    parser.add_argument('--snis', action="store_true", default=False)
    # ---------------------------------------------------------------------- #
